package com.dream.cleaner.ui.plan.calendarview;
...
public class CustomMonthView extends MonthView {
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        ...
        if (isSelected) {
            ...
            mPointPaint.setColor(ShapeUtils.getColor(R.color.color_72BB38));
        }
...
//        }
        ...
        if (hasScheme) {
            ...
            canvas.drawText(calendar.getScheme(), x , y + mPadding + mSchemeBaseLine, mTextPaint);
        }
