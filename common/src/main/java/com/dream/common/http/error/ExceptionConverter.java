...
public class ExceptionConverter {
    ...
    public static ApiException convertException(Throwable throwable) {
        ...
        if (throwable instanceof ApiException) {
            ...
            errorMessage = "retrunValue为空异常";
            errorType = ErrorType.ERROR_NULL;
            apiException = new ApiException(ErrorCode.SERVER_ERROR_CODE_9111, errorType, errorMessage, throwable);
        } else if (throwable instanceof HttpException) {
            apiException = handleHttpException(throwable, errorMessage);
    ...
    @NotNull
    private static ApiException handleHttpException(Throwable throwable, String errorMessage) {
        ErrorType errorType;
        int errorCode;
        ApiException apiException;
